...
define ['responseInterceptors/responseInterceptors'], (responseInterceptors) ->
  'use strict'

  responseInterceptors.provider 'authService', () ->
    ###
  ...
  responseInterceptors.config ['$httpProvider','authServiceProvider'
